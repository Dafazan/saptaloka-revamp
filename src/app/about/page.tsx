...
export default function About() {
  return (
    <main>
      <div className="h-screen w-full relative overflow-hidden">
        ...
        <div className="w-full h-full absolute">
          <div className="w-full h-screen flex flex-col">
            <div className=" md:h-[65%] h-[50%] inset-0 flex items-center w-full px-[4%] pt-[100px]">
              ...
              <div className="flex flex-col z-0  px-[2%] w-full items-center pt-64 gap-3 hidden md:block">
            ...
            <div className="flex md:w-6/12 px-[5%] flex-col w-full ">
      ...
      <div className=" w-full relative overflow-hidden bg-[#000D32] px-[30px] md:px-[62px] py-[65px]">
        <div className="w-full md:pb-[45px] pb-[20px]">
          <h1 className=" text-sky-200 text-3xl font-extrabold">
            STORY OF PT.SAPTALOKA DIGITAL INDONESIA
          </h1>
        </div>
        <div className="flex w-10/12 items-start pl-10  justify-center relative block md:hidden">
          <svg
        ...
        <div className="flex w-full">
          <div className="flex md:w-7/12 flex-col">
            ...
            <h2 className="text-sky-200 md:text-justify text-xl font-medium">
            ...
            <h2 className="text-sky-200 text-xl md:text-justify font-medium">
            ...
            <h2 className="text-sky-200 text-xl md:text-justify font-medium pt-6">
          ...
          <div className="flex w-5/12 items-start pl-10  justify-center relative hidden md:block">
            <svg
              className="w-[380px] h-[276px] "
              width="380"
              height="276"
        ...
        <div className="w-full">
          <h2 className="text-sky-200 text-xl md:text-justify font-medium pt-8 ">
      ...
      <div className=" w-full relative overflow-hidden bg-[#C2EDFF] px-[30px] md:px-[62px] py-[75px]">
        <div className="flex w-8/12 justify-center pb-8 block md:hidden">
          <svg
            width="264"
            height="73"
            viewBox="0 0 264 73"
        ...
        <div className="flex w-full">
          ...
          <div className="flex w-3/12 pl-10 justify-center hidden md:block">
            <svg
              width="264"
              height="73"
              viewBox="0 0 264 73"
        ...
        <div className="w-full md:px-[62px] py-[75px]">
          <svg
            width="1323"
            height="3"
            viewBox="0 0 1323 3"
        ...
        <div className="flex w-8/12 justify-center block md:hidden pb-10">
          <svg
            width="253"
            height="75"
            viewBox="0 0 253 75"
        ...
        <div className="flex w-full ">
          <div className="flex w-3/12 justify-center hidden md:block">
            <svg
              width="253"
              height="75"
              viewBox="0 0 253 75"
