            ...
            <div className=" w-full relative overflow-hidden bg-[#000820] px-[62px] py-[75px]">
                ...
                <div className="grid grid-cols-3 w-full pt-16 gap-5">
                    <Team
                        ...
                        foto={"/Rectangle 76.png"} linked={undefined} ig={undefined} web={undefined} />
                    <Team
                        nama={"Taryo Noviar.zip"}
                        jabatan={"Front-end Developer"}
                        foto={"/Rectangle 77.png"} linked={undefined} ig={undefined} web={undefined} />
                    <Team
                        nama={"M. Daffa Fauzan"}
                        jabatan={"UI/UX Designer"}
                        foto={"/Rectangle 78.png"} linked={undefined} ig={undefined} web={undefined} />
                    <Team
                        nama={"Luthfi Khaeri Ikhsan"}
                        jabatan={"Back-end Developer"}
                        foto={"/Rectangle 79.png"} linked={undefined} ig={undefined} web={undefined} />
                    <Team
                        nama={"M. Aulia Rahman, S.Kom"}
                        jabatan={"Front-end Developer"}
                        foto={"/Rectangle 80.png"} linked={undefined} ig={undefined} web={undefined} />
                </div>
            </div>
        </main>
    );
