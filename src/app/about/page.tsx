        ...
        <main>
                ...
                <div className="w-full h-full absolute">
                    <div className="w-full h-screen flex flex-col">
                        <div className=" h-[65%] inset-0 flex items-center w-full px-[4%] pt-[100px]">
                            ...
                            <div className="flex flex-col  px-[2%] w-full items-center pt-64 gap-3">
                                <div className="absolute z-10 top-[130px] right-[230px]">
                                    <img className="w-[453px] h-[267px]" src="/Rectangle 61.png"></img>
                                </div>
                                <div className="absolute z-20 top-[263px] right-[425px]">
                                    <img className="w-[453px] h-[267px]" src="/Rectangle 62.png"></img>
                                </div>
                                <div className="absolute z-30 top-[419px] right-[110px]">
                                    <img className="w-[453px] h-[267px]" src="/Rectangle 63.png"></img>
                                </div>
            ...
            <div className="h-screen w-full relative overflow-hidden bg-[#000D32] px-[62px] py-[75px]">
                ...
                <div className="flex w-full">
                    <div className="flex w-7/12 flex-col">
                        ...
                        <h2 className="text-sky-200 text-xl text-justify font-medium">
                            MERUPAKAN JASA IT CONSULTANT YANG BERDIRI PADA TAHUN 2020.
                    ...
                    <div className="flex w-5/12 items-start justify-center relative">
                        <svg className="w-[380px] h-[276px] " width="380" height="276" viewBox="0 0 380 276" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_125_251)">
                                ...
                                <path d="M42.7781 246.822L133.312 156.706C141.188 148.867 141.188 136.157 133.312 128.318C125.437 120.48 112.669 120.48 104.794 128.318L14.2593 218.435C6.38405 226.274 6.38405 238.983 14.2593 246.822C22.1345 254.661 34.9029 254.661 42.7781 246.822Z" fill="#0E41A2" />
                                <path d="M259.635 0H141.791C130.654 0 121.625 8.98687 121.625 20.0727C121.625 31.1586 130.654 40.1455 141.791 40.1455H259.635C270.772 40.1455 279.801 31.1586 279.801 20.0727C279.801 8.98687 270.772 0 259.635 0Z" fill="#2ABDFB" />
                                <path d="M141.791 103.5H28.9886C17.8513 103.5 8.82275 112.487 8.82275 123.573C8.82275 134.659 17.8513 143.645 28.9886 143.645H141.791C152.929 143.645 161.957 134.659 161.957 123.573C161.957 112.487 152.929 103.5 141.791 103.5Z" fill="#2ABDFB" />
                                <path d="M161.957 123.573V20.0727C161.957 8.98687 152.928 0 141.791 0C130.654 0 121.625 8.98687 121.625 20.0727V123.573C121.625 134.659 130.654 143.645 141.791 143.645C152.928 143.645 161.957 134.659 161.957 123.573Z" fill="#2ABDFB" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M229.386 76.4865H266.597H294.947C341.92 76.4865 380 114.39 380 161.146V191.13C380 237.886 341.92 275.79 294.947 275.79H266.597H229.386V76.4865ZM294.877 235.216H269.527V118.221H294.877C319.342 118.221 339.175 137.962 339.175 162.314V191.122C339.175 215.474 319.342 235.216 294.877 235.216Z" fill="#2ABDFB" />
                            </g>
                            <defs>
                ...
                <div className="w-full">
                    <h2 className="text-sky-200 text-xl text-justify font-medium pt-8 ">
                        SELAMA PERJALANAN BERTRANSFORMASI INI,
                        SAPTALOKA DIGITAL INDONESIA TELAH MEMBUKTIKAN KOMITMENNYA DENGAN MENCIPTAKAN BERBAGAI PROYEK INOVATIF.
                        DARI IMPLEMENTASI SISTEM ENTERPRISE RESOURCE PLANNING (ERP) YANG EFISIEN HINGGA SOLUSI MANUFACTURING
                        EXECUTION SYSTEM (MES) YANG TERDEPAN, SAPTALOKA TERUS MENUNJUKKAN DEDIKASINYA DALAM MENYEDIAKAN SOLUSI
                        TEKNOLOGI YANG CANGGIH DAN TERPERCAYA BAGI KLIEN-KLIENNYA. KLIEN-KLIEN MEREKA BERASAL DARI BERAGAM LATAR
                        BELAKANG, MULAI DARI PERUSAHAAN NEGARA HINGGA PERUSAHAAN SWASTA.
                    </h2>
                </div>
            </div>
            <div className="h-[700px] w-full relative overflow-hidden bg-[#C2EDFF] px-[62px] py-[75px]">
                <div className="flex w-full">
                    <div className="flex w-9/12 flex-col gap-8">
                        ...
                        <h2 className="text-justify text-slate-900 text-xl font-medium">
                            SAPTALOKA DIGITAL MENAWARKAN JASA IT BERUPA PERMBUATAN WEBSITE, MULTIPLATFORM APPS DAN GAME,
                            DAN JUGA MENAWARKAN JASA DIGITAL MARKETING.
                        </h2>
                        <h2 className="text-justify text-slate-900 text-xl font-medium">
            ...
            <div className="h-[1353px] w-full relative overflow-hidden bg-[#000820] px-[62px] py-[75px]">
                ...
                <div className="flex w-full justify-center items-center px-12 py-20">
                    <div className="flex w-6/12 justify-center items-center flex-col">
                        <Founder nama={'M. Nur Rizka Novanto, S.E'} jabatan={'FOUNDER & CEO'} foto={"/Rectangle 73.png"} />
                    </div>
                    <div className="flex w-6/12 justify-center items-center flex-col">
                        <Founder nama={'Fikri Zaki Aditama, S.Si'} jabatan={'FOUNDER & HEAD OF IT'} foto={'/Rectangle 75.png'} />
                    </div>
                </div>
                <div className="flex w-full flex-row pt-16">
                    <Team nama={'Asép Wahyu Kurnia'} jabatan={'Back-end Developer'} foto={'/Rectangle 76.png'} />
                    <Team nama={'Taryo Noviansyah'} jabatan={'Front-end Developer'} foto={'/Rectangle 77.png'} />
                    <Team nama={'M. Daffa Fauzan'} jabatan={'UI/UX Designer'} foto={'/Rectangle 78.png'} />
                    <Team nama={'Luthfi Khaeri Ikhsan'} jabatan={'Back-end Developer'} foto={'/Rectangle 79.png'} />
                    <Team nama={'M. Aulia Rahman'} jabatan={'Front-end Developer'} foto={'/Rectangle 80.png'} />
                </div>
            </div>
